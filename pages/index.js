...
const heroProducts = [
  {
    ...
    description: "Colorful Gradient Luminous Crystal Ball Night Light",
  ...
  },
  {
    ...
    description: "Coffee Cup Mixed Blender Portable Smart Cup",
    image: "/api/placeholder/500/350",
    price: "$43.50",
    originalPrice: "$69.99",
    discount: "38% OFF",
...
const collections = [
  {
    id: 1,
    name: "Car LED Door Warning Light",
    price: "$9.99",
    originalPrice: "$19.99",
    discount: "50% OFF",
    image: "/api/placeholder/180/180",
  ...
  {
    id: 4,
    name: "Magnetic Double Sided Glass Cleaning Brush",
    price: "$23.00",
    originalPrice: "$29.99",
    discount: "23% OFF",
    image: "/api/placeholder/180/180",
  ...
  {
    id: 5,
    name: "Sport Wrist Bag - Large Capacity Storage",
    price: "$14.99",
    originalPrice: "$24.99",
    discount: "40% OFF",
    image: "/api/placeholder/180/180",
  ...
  {
    id: 6,
    name: "Gold Mama Pendant Necklace Stylish",
    price: "$21.50",
    originalPrice: "$35.00",
    discount: "39% OFF",
    image: "/api/placeholder/180/180",
...
const popularProducts = [
  ...
  {
    id: 2,
    name: "Silicone Kitchen Sink Faucet Mat",
    price: "$7.59",
    originalPrice: "$15.99",
    discount: "53% OFF",
    image: "/api/placeholder/180/180",
  ...
  {
    id: 3,
    name: "Seamless Full Body Shapewear",
    price: "$15.65",
    originalPrice: "$25.75",
    discount: "39% OFF",
    image: "/api/placeholder/180/180",
  ...
  {
    id: 4,
    name: "15-in-1 Upgrade Screwdriver Set",
    price: "$12.39",
    originalPrice: "$19.97",
    discount: "38% OFF",
    image: "/api/placeholder/180/180",
...
const mostSearchedProducts = [
  ...
  {
    id: 2,
    name: "Wall Mounted Iron Board Holder with Steel Hooks",
    image: "/api/placeholder/150/150",
  },
  {
    id: 3,
    name: "Flower Design Tube Shape Bottle Paper Soap",
    image: "/api/placeholder/150/150",
  },
  {
    id: 4,
    name: "Nordic Light Luxury Home Furnishing Astrolabe",
    image: "/api/placeholder/150/150",
  },
  {
    id: 5,
    name: "4DRC V17 FPV Foam RC Airplane",
    image: "/api/placeholder/150/150",
  },
  {
    id: 6,
    name: "Mini Creative Eco-friendly Colourful Round Plant Pot",
    image: "/api/placeholder/150/150",
  },
];

// Main category groups for sidebar
const mainCategoryGroups = [
  {
    id: 1,
    name: "Electronics",
    icon: "💻",
    subcategories: ["Computers", "Phones", "Accessories", "Smart Home"],
  },
  {
    id: 2,
    name: "Fashion",
    icon: "👕",
    subcategories: ["Men's Clothing", "Women's Clothing", "Shoes", "Jewelry"],
  },
  {
    id: 3,
    name: "Home & Garden",
  ...
  },
  {
    ...
    name: "Toys & Kids",
    icon: "🧸",
    subcategories: ["Toys", "Baby", "Children's Clothing", "School Supplies"],
  },
  {
    id: 7,
    name: "Automotive",
    icon: "🚗",
    subcategories: ["Interior", "Exterior", "Tools", "Car Electronics"],
  },
];
...
const heroSlides = [
  {
    id: 1,
    title: "New Arrivals",
    description: "Discover the latest in technology and home goods",
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg py-2.5 px-4 mb-6 overflow-hidden relative">
          <div className="deals-ticker-wrap">
            <div className="deals-ticker">
              <div className="deals-ticker-item">🔥 Flash Deal: 50% OFF on all Smart Home Devices for the next 24 hours!</div>
              <div className="deals-ticker-item">🎁 Buy One Get One Free on selected Electronics - Limited time offer!</div>
              <div className="deals-ticker-item">💰 New Customers: Use code WELCOME15 for 15% off your first purchase</div>
              <div className="deals-ticker-item">🚚 Free shipping worldwide on orders over $75 - Today Only!</div>
              <div className="deals-ticker-item">⚡ Lightning Deal: Premium Wireless Earbuds just $29.99 - Was $89.99</div>
            </div>
          </div>
        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="relative hidden md:block">
                        ...
                        <div className="absolute top-4 right-4 bg-white text-orange-600 text-xs font-bold px-2.5 py-1.5 rounded-md">
                          {index === 0 ? "Featured Deal" : index === 1 ? "Best Seller" : "New Arrival"}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="absolute left-0 right-0 bottom-0 translate-y-full opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 pointer-events-none">
                  <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded mx-2 my-1 max-w-[200px]">
                    Top rated product with exceptional value. Limited time offer with free shipping.
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {flashDeals.map((product) => (
              ...
              >
                ...
                <div className="absolute left-0 right-0 bottom-0 translate-y-full opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 pointer-events-none">
                  <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded mx-2 my-1 max-w-[200px]">
                    Fast shipping with excellent customer satisfaction. Limited time offer.
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {collections.map((product) => (
              ...
              >
                ...
                <div className="absolute left-0 right-0 bottom-0 translate-y-full opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 pointer-events-none">
                  <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded mx-2 my-1 max-w-[200px]">
                    Perfect for all home and office use - easy to install and adjust.
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {popularProducts.map((product) => (
              ...
              >
                ...
                <div className="absolute left-0 right-0 bottom-0 translate-y-full opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 pointer-events-none">
                  <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded mx-2 my-1 max-w-[200px]">
                    High-quality product from trusted sellers - perfect for {product.category}.
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {mostSearchedProducts.map((product) => (
              ...
              >
                ...
                <div className="absolute left-0 right-0 bottom-0 translate-y-full opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 pointer-events-none">
                  <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded mx-2 my-1 max-w-[200px]">
                    Trending product with high search volume. Highly rated by customers.
                  </div>
                </div>
              </div>
            ))}
