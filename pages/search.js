...
const Search = () => {
  ...
  const [recentSearches, setRecentSearches] = useState([
    "night light", "USB charger", "kitchen gadgets", "wireless earbuds"
  ]);
  ...
  const filteredAndSortedResults = () => {
    ...
    if (activeFilters.rating) {
      results = results.filter(product => product.rating >= activeFilters.rating);
    }
  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-6">
        {/* Search Header */}
        <div className="mb-6">
          <form onSubmit={handleSearch} className="flex w-full max-w-4xl mx-auto mb-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {mobileFiltersOpen && (
            <div className="fixed inset-0 z-50 lg:hidden">
              <div className="absolute inset-0 bg-black opacity-50" onClick={() => setMobileFiltersOpen(false)}></div>
                      ...
                      {categories.map((category, index) => (
                        <div key={index} className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor={`m-category-${index}`} className="ml-2 text-sm text-gray-700">
                            {category}
                          </label>
                        </div>
                      ))}
                      ...
                      {priceRanges.map((range, index) => (
                        <div key={index} className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor={`m-price-${index}`} className="ml-2 text-sm text-gray-700">
                            {range.label}
                          </label>
                        </div>
                      ))}
                      ...
                      {ratings.map((rating, index) => (
                        <div key={index} className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300"
                          />
                          <label htmlFor={`m-rating-${index}`} className="ml-2 text-sm text-gray-700 flex items-center">
                            <div className="flex items-center">
                              {[...Array(5)].map((_, i) => (
                                <Star
                                  key={i}
                  ...
                  <div className="mb-6">
                    <div className="flex items-center mb-3">
                      <input
                        ...
                        className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded"
                      />
                      <label htmlFor="m-discount" className="ml-2 text-sm text-gray-700">
                        Discount Items
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded"
                      />
                      <label htmlFor="m-freeShipping" className="ml-2 text-sm text-gray-700">
                        Free Shipping
                      </label>
                    </div>
                  </div>
              ...
              {activeFilterCount > 0 && (
                <div className="flex flex-wrap gap-2 mt-3">
                  {activeFilters.categories.map(category => (
                    <div key={category} className="bg-gray-100 text-xs text-gray-800 rounded-full px-3 py-1 flex items-center">
                      <span>{category}</span>
                      <button 
                  ...
                  {activeFilters.priceRange.map(range => {
                    ...
                    return (
                      <div key={range} className="bg-gray-100 text-xs text-gray-800 rounded-full px-3 py-1 flex items-center">
                  ...
                  {activeFilters.rating && (
                    <div className="bg-gray-100 text-xs text-gray-800 rounded-full px-3 py-1 flex items-center">
                      <span>{ratings.find(r => r.value === activeFilters.rating)?.label}</span>
                      <button 
            ...
            {!isLoading && displayResults.length > 0 && (
              <div className={viewMode === 'grid' 
                ...
                {displayResults.map((product) => (
                  viewMode === 'grid' ? (
                    // Grid view
                    <div key={product.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200 group">
                    ...
                    // List view
                    <div key={product.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200 flex group">
