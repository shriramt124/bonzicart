...
/**
 * CategoryMenu component that displays category navigation with mega menus
 */
        ...
        <div className="flex space-x-6">
            {categories.map((category) => (
                <div key={category.name} className="relative group">
                    ...
                    {/* Enhanced Mega menu with improved positioning */}
                    <div className="absolute left-0 mt-2 w-screen max-w-4xl bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-30 -translate-x-1/4 transform-gpu pointer-events-none group-hover:pointer-events-auto" style={{ minHeight: '340px' }}>
