...
import { Star, Heart, ShoppingCart, Share2, Truck, Shield, RefreshCcw, Award, ChevronRight, ChevronDown, Plus, Minus } from "lucide-react";
    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-4">
          ...
          <Link href="/search" className="hover:text-orange-500">All Products</Link>
          <ChevronRight size={14} className="mx-1" />
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-3/5 p-4 border-t md:border-t-0 md:border-l border-gray-100">
              ...
              <div className="flex items-center mb-3">
                ...
                <span className="text-sm text-gray-500 mr-3">{productData.rating}</span>
                ...
                <span className="text-sm text-gray-500">
                  <span className="text-green-500 font-medium">In Stock</span> ({productData.stock} available)
                </span>
              </div>
              ...
              <div className="flex items-center text-sm text-gray-600 mb-4">
                ...
                <span className="ml-2 flex items-center">
                  <span className="text-yellow-400">★</span> {productData.sellerRating}
                </span>
              </div>
              ...
              <div className="bg-gray-50 p-3 rounded-lg mb-4">
                <div className="flex items-center text-sm text-gray-700 mb-2">
                  ...
                  <span><strong>Free Shipping</strong> - Estimated delivery in {productData.delivery}</span>
                </div>
                <div className="flex items-center text-sm text-gray-700 mb-2">
                  <RefreshCcw size={16} className="text-orange-500 mr-2" />
                  <span><strong>{productData.returnPolicy}</strong> - Money back guarantee</span>
                </div>
                <div className="flex items-center text-sm text-gray-700">
                  <Shield size={16} className="text-orange-500 mr-2" />
                  <span><strong>{productData.warranty}</strong> against defects</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-4">
              {activeTab === "description" && (
                <div className="prose prose-sm max-w-none">
                  ...
                  <p>
                    This innovative egg separator is designed to make your kitchen tasks easier and more efficient. 
                    The unique design allows for clean separation of egg whites and yolks with minimal mess. 
                    Made from high-quality food-grade silicone, it's safe for use with all types of eggs.
                  </p>
                  <p>
                    The built-in bottle opener feature adds extra utility to this kitchen gadget, saving you space 
                    and providing multiple functions in one compact tool. Perfect for home cooks who appreciate 
                    efficient, multi-purpose tools.
                  </p>
                </div>
              )}
              ...
              {activeTab === "features" && (
                <div className="space-y-3">
                  <h3 className="text-sm font-medium text-gray-800">Key Features</h3>
              ...
              {activeTab === "specifications" && (
                <div className="space-y-4">
                  <h3 className="text-sm font-medium text-gray-800">Product Specifications</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {Object.entries(productData.specifications).map(([key, value]) => (
                      <div key={key} className="flex border-b border-gray-100 pb-2">
                        <span className="w-1/2 text-sm text-gray-500 capitalize">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                        <span className="w-1/2 text-sm text-gray-800">{value}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="border-t border-b border-gray-100 py-4">
                    <div className="mb-4">
                      <div className="flex justify-between items-start mb-1">
                        <div className="flex items-center">
                          <span className="font-medium text-gray-800 mr-2">Sarah J.</span>
                      ...
                      <h4 className="text-sm font-medium text-gray-800 mb-1">Perfect for my needs!</h4>
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-1">
                        <div className="flex items-center">
                          <span className="font-medium text-gray-800 mr-2">Michael T.</span>
                          <span className="text-xs text-gray-500">Verified Purchase</span>
                        </div>
                      ...
                      <h4 className="text-sm font-medium text-gray-800 mb-1">Good quality, takes practice</h4>
                      <p className="text-sm text-gray-600">
        ...
        <div className="mt-10">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-medium text-gray-800">You May Also Like</h2>
